...
/* harmony import */ var _stopScroll__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./stopScroll */ "./src/js/stopScroll.js");
...
var Burger = function Burger() {
  ...
  openBurgerBtn.addEventListener('click', function () {
    ...
    Object(_stopScroll__WEBPACK_IMPORTED_MODULE_0__["stopScroll"])();
  });
...
Object(_modal__WEBPACK_IMPORTED_MODULE_4__["modal"])();
...
var modal = function modal() {
  ...
  var modalBtns = document.querySelectorAll('.callback__btn');
  var closeModalBtns = document.querySelectorAll('.modal__close');
  modalBtns.forEach(function (btn) {
    if (btn.hasAttribute('data-modal')) {
      btn.addEventListener('click', function () {
        var sidebar = document.querySelector('.sidebar');
        var showModalAttr = btn.getAttribute('data-modal');
        var showModal = document.querySelector(".".concat(showModalAttr));
  ...
  moreBtns.forEach(function (btn) {
    btn.addEventListener('click', function () {
      ...
      if (showElement.classList.contains("".concat(showAttr, "--active"))) {
        showElement.classList.remove("".concat(showAttr, "--active")); // btn.querySelector('span').textContent = 'Читать далее';
...
var sidebar = function sidebar() {
  ...
  var sidebarPos = function sidebarPos() {
    ...
    if (window.innerWidth >= 1440) {
      sidebar.style.left = "".concat(containerLeft - 320, "px");
    }
  };
...
/***/ "./src/js/stopScroll.js":
/*!******************************!*\
  !*** ./src/js/stopScroll.js ***!
  \******************************/
/*! exports provided: stopScroll */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
